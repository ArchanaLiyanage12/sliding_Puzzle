...
public class Main {
    ...
    public static void main(String[] args){
        ...
        // change the folder name to run the test cases in example_1
        // should be changed as "test-cases\\examples_2\\"
        String filePath = "test-cases\\examples_2\\";
        Scanner sc=new Scanner(System.in);
        System.out.print("Enter the file name (Eg :- puzzle_x.txt): ");
